...
```{r}
glm_mod <- glm(list_price ~ ages + piece_count + num_reviews + play_star_rating + 
...
### Enet Model
```{r}
enet_mod <- cva.glmnet(list_price ~ ages + piece_count + num_reviews + 
